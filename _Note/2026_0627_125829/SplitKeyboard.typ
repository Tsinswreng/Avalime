...
現在還發現了一個新問題
avalime是有一個強行重口鍵盤的常駐通知的
當出現上面的 「只能在分體模式下打字」的問題時，我點了一下常駐通知 試圖重啓鍵盤
鍵盤確實重啓了、也能在非分體模式下打字了
但是 ascii模式和非ascii模式下的鍵盤分別變成了這樣子
#image("assets/2026-06-27-20-18-06.png")
#image("assets/2026-06-27-20-18-12.png")
就是 很多按鍵的圖標不顯示了
但還能正常點擊
你看看是怎麼回事
